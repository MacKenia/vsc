...
!(function (t, e) {
    ...
    function $(t, e, n) {
        for (
            var r, o, i, a, s, h, l = t.length, c = 1e20, g = 0, f = 0;
            -1 < --l;
    ...
    function ba(t, e, n, r, o) {
        ...
        if (u[0]) {
                    ...
                    (n = v[w] || 0 === v[w] ? v[w] : "auto") &&
                        ...
                        (Math.abs(a[0] - a[a.length - 2]) < 0.5 &&
                            ...
                            ? "auto" === n || "log" === n
                                ? ((v[w] = n = Z(a, i, !w || !1 === o)),
                                  n < 0 &&
                                      ((y = !0), reverseSegment(a), (n = -n)),
                                  X(a, 6 * n))
                                : "reverse" !== n &&
                                  (w && n < 0 && reverseSegment(a),
                                  X(a, 6 * (n < 0 ? -n : n)))
                            : !y &&
                              (("auto" === n &&
                                  Math.abs(i[0] - a[0]) +
            ...
            return (
                x && M("shapeIndex:[" + v.join(",") + "]"), (t.shapeIndex = v)
            );
        }
    }
    ...
    var o,
        ...
        H = (function (t) {
            var e =
                    ...
                    -1 !==
                        t.indexOf(
                            P(108, 111, 99, 97, 108, 104, 111, 115, 116)
                        ) ||
